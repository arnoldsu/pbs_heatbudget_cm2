...
metrics = calculate_climate_metrics_region(
    ...
    ds_t=dsa_t, ds_u=dsb_u, ds_v=dsb_v, ds_w=dsb_w, ds_hf=dsb_hf)
...
ds.to_netcdf(f'{script_directory}/climate_metrics_mpi_heatbudget_pac_' + rpfName + '_gn_' + prdName + '_ab.nc')
