...
metrics = calculate_climate_metrics_region(
    ...
    ds_t=dsb_t, ds_u=dsa_u, ds_v=dsa_v, ds_w=dsa_w, ds_hf=dsa_hf)
...
ds.to_netcdf(f'{script_directory}/climate_metrics_mpi_heatbudget_pac_' + rpfName + '_gn_' + prdName + '_ba.nc')

print('NetCDF file saved as climate_metrics_mpi_heatbudget_pac_' + rpfName + '_gn_' + prdName + '_ab.nc.')
