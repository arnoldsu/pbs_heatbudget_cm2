...
dsa_t = xr.open_dataset(f"{inDir}/thetao_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.anom.nc")
dsa_u = xr.open_dataset(f"{inDir}/uo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.anom.nc")
dsa_v = xr.open_dataset(f"{inDir}/vo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.anom.nc")
dsa_w = xr.open_dataset(f"{inDir}/wo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.anom.nc")
dsa_hf = xr.open_dataset(f"{inDir}/hfds_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.anom.nc")

dsb_t = xr.open_dataset(f"{inDir}/thetao_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.bar.nc")
dsb_u = xr.open_dataset(f"{inDir}/uo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.bar.nc")
dsb_v = xr.open_dataset(f"{inDir}/vo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.bar.nc")
dsb_w = xr.open_dataset(f"{inDir}/wo_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.bar.nc")
dsb_hf = xr.open_dataset(f"{inDir}/hfds_Omon_ACCESS-CM2_historical_" + rpfName + "_gn_" + prdName + "_v10.bar.nc")
...
metrics = calculate_climate_metrics_region(
    ...
    ds_t=dsa_t, ds_u=dsa_u, ds_v=dsa_v, ds_w=dsa_w, ds_hf=dsa_hf)
...
ds.to_netcdf(f'{script_directory}/climate_metrics_mpi_heatbudget_pac_' + rpfName + '_gn_' + prdName + '_aa.nc')

print('NetCDF file saved as climate_metrics_mpi_heatbudget_pac_' + rpfName + '_gn_' + prdName + '_aa.nc.')
